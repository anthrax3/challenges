...
.controller('sidebarCtrl', function() {
	...
	main.challenges = [
		...
		{"num":"01", "info":['Higher/Lower', check]},
		...
		{"num":"06", "info":['Rock Paper Scissors', check]},
		{"num":"07", "info":['Hangman', check]},
		{"num":"08", "info":['Love Calculator', '']},
		{"num":"09", "info":['Pseudorandom Sentence', '']},
		{"num":"10", "info":['Password Generator', check]},
		{"num":"11", "info":['Atomically Correct Time', '']},
		{"num":"12", "info":['Haiku Generator', '']},
		{"num":"13", "info":['Magic Eight Ball', '']},
		{"num":"14", "info":['Collatz Conjecture', '']},
		{"num":"15", "info":['Reverse a String', check]},
		...
		{"num":"21", "info":['4chan Thread Downloader', '']},
		...
		{"num":"28", "info":['Calculate 100 Factorial', '']},
		{"num":"29", "info":['Encrypt/Decrypt Cipher', '']},
		{"num":"30", "info":['Blackjack', '']},
		{"num":"31", "info":['Dungeons & Dragons AI', '']},
		{"num":"32", "info":['Generate ASCII Tree', '']},
		{"num":"33", "info":['Polygon Genetic Algorithm', '']},
		...
		{"num":"66", "info":['Prime Numbers with a Sieve', '']},
		{"num":"67", "info":['Markov Chain', '']},
		{"num":"68", "info":['Graphical Analog Clock + GUI', '']},
		{"num":"69", "info":['Strings Between 2 Languages', '']},
		...
		{"num":"80", "info":['Polygon Manipulation', '']},
		{"num":"81", "info":['Pong with Variable Vectors', '']},
		{"num":"82", "info":['Battleships with AI', '']},
		{"num":"83", "info":['Simple Paint Program', '']},
		{"num":"84", "info":['TCP Chat with XOR Encryption', '']},
		{"num":"85", "info":['Economy Simulator', '']},
		{"num":"86", "info":['Encrypt/Decrypt Image Text', '']},
		...
		{"num":"96", "info":['Dot & Cross of 2 Vectors', '']},
